...
# ✅ GLOBAL SIGNAL CONTROL (prevents spam)
last_global_signal_time = None
GLOBAL_SIGNAL_COOLDOWN = 10  # seconds
signal_in_progress = False  # NEW: prevent multiple signals at once
...
def send_signal(pair, direction, accuracy, strength):  
    global last_global_signal_time, signal_in_progress

    # ✅ Prevent multiple global signals
    ...
    signal_in_progress = False  # reset after sending
